...
**⭐ Начните отсюда:** [📑 Навигация по документации (INDEX.md)](INDEX.md) — найдите нужную тему за секунду!
...
### Данные
- [**Модели данных**](05-data-models.md) — Prisma схемы всех сервисов (v1.2.0 с 3NF нормализацией)
  - Auth Service (User, RefreshToken)
  - Personnel Service (Department, Position, Employee, Location, PostalArea, Workstation, ShiftScheduleTemplate)
  - Production Service (Product, ProductionOrder, Sale, Inventory, Customer, QualityResult, QualitySpec, Sensor, SensorParameter, Warehouse)
