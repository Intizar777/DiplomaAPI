...
- **Instrumentation**: OpenTelemetry auto-instrumentation for HTTP, Express, amqplib, and Pino (log-trace correlation)
...
| `libs/nest-utils/src/tracing/tracing.ts` | OpenTelemetry bootstrap (HTTP, Express, amqplib, Pino instrumentation) |
| `libs/nest-utils/src/metrics/metrics.module.ts` | Prometheus metrics module |
| `libs/nest-utils/src/messaging/rmq-event-emitter.service.ts` | RabbitMQ event emitter (supports header propagation) |
