...
- подразделений
- локаций (офисы, склады)
- производственных линий
- рабочих мест и назначений сотрудников
- должностей
- сотрудников
- шаблонов смен
...
- `/api/personnel/production-lines` — создание производственных линий
- `/api/personnel/workstations` — создание рабочих мест
- `/api/personnel/workstations/assign` — назначение сотрудника на рабочее место
