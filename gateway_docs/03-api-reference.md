...
Управление кадровыми данными: подразделения, должности, сотрудники, шаблоны смен, локации, производственные линии, рабочие места.
...
- `employmentType?` — Тип занятости (FULL_TIME, PART_TIME, CONTRACT)
- `offset?` — Смещение для пагинации (default: 0, min: 0)
- `limit?` — Лимит записей (default: 20, min: 1, max: 100)
...
# Комбинированная фильтрация
curl -X GET "http://localhost:3000/api/personnel/employees?departmentId=a1b2c3d4-e5f6-7890-abcd-ef1234567890&status=ACTIVE&employmentType=FULL_TIME" \
  -H "Authorization: Bearer <accessToken>"
